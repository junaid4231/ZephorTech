...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Thought leadership contributors";
    displayName: "Author";
    pluralName: "authors";
    singularName: "author";
  };
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Insights, announcements, and articles";
  ...
  attributes: {
    ...
    contentSections: Schema.Attribute.Component<"blog.content-section", true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    ...
    impactStats: Schema.Attribute.Component<"blog.impact-stat", true>;
    keyTakeaways: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::blog-post.blog-post"> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    pullQuote: Schema.Attribute.Component<"blog.quote-block", false>;
    readingTime: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<6>;
    relatedPosts: Schema.Attribute.Relation<"manyToMany", "api::blog-post.blog-post">;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Real client project stories with results and metrics";
  ...
  attributes: {
    challenge: Schema.Attribute.JSON;
    ...
    slug: Schema.Attribute.UID<"title"> & Schema.Attribute.Required & Schema.Attribute.Unique;
    strategy: Schema.Attribute.JSON;
    summary: Schema.Attribute.Text & Schema.Attribute.Required;
    technologies: Schema.Attribute.JSON;
    testimonial: Schema.Attribute.JSON;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Service offerings of ZephorTech";
    displayName: "Service";
    pluralName: "services";
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    faq: Schema.Attribute.Component<"service.faq", true>;
    features: Schema.Attribute.Component<"service.feature", true>;
    fullDescription: Schema.Attribute.RichText & Schema.Attribute.Required;
    heroImage: Schema.Attribute.Media<"images">;
    heroStats: Schema.Attribute.JSON & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<"oneToMany", "api::service.service"> &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    process: Schema.Attribute.Component<"service.process-step", true>;
    publishedAt: Schema.Attribute.DateTime;
    relatedServices: Schema.Attribute.Relation<"manyToMany", "api::service.service">;
    seoDescription: Schema.Attribute.Text;
    seoTitle: Schema.Attribute.String;
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    useCases: Schema.Attribute.Component<"service.use-case", true>;
  };
}
...
export interface ApiUseCaseUseCase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Use cases and industry applications that can be associated with services";
  ...
  attributes: {
    ...
    industry: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::use-case.use-case"> &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Relation<"manyToMany", "api::service.service">;
