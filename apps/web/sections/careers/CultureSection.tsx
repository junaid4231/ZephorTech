...
const cultureValues = [
  ...
  },
  {
    ...
    description:
      "Every line of code we write is in service of creating real value for our clients.",
  ...
  },
  {
    ...
    stats: "12+ countries represented",
  },
  {
    icon: Rocket,
...
const teamQuotes = [
  {
    quote:
      "The level of autonomy and trust here is unmatched. I can experiment, fail fast, and iterate without fear.",
    author: "Sarah Chen",
  ...
  {
    quote:
      "Working with brilliant people who genuinely care about craft and impact—that's what keeps me here.",
  ...
  {
    quote:
      "Remote-first doesn't mean isolated. The culture of async collaboration is incredibly effective.",
    author: "Aisha Patel",
    ...
    >
      <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="heading-2 mb-3 font-bold text-white">What We Value</h2>
          <p className="mx-auto max-w-2xl text-sm text-white/70 md:text-base">
            Our culture is built on trust, excellence, and a shared commitment to building something
            meaningful.
          </p>
        </div>

        {/* Culture Values Grid */}
        <div className="mb-8 grid gap-4 md:mb-10 md:grid-cols-2 md:gap-5 lg:grid-cols-3">
          {cultureValues.map((value, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="mb-3 text-sm leading-relaxed text-white/60 md:mb-4 md:text-base">
                  {value.description}
                </p>
        ...
        >
          <h3 className="heading-3 mb-6 text-center text-white md:mb-8">Hear From Our Team</h3>
            ...
            {teamQuotes.map((testimonial, index) => (
              ...
              >
                ...
                <div className="border-t border-white/10 pt-3 md:pt-4">
                  ...
                  <p className="text-primary mt-1 text-xs">With us for {testimonial.tenure}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        >
          ...
          >
            ...
            <p className="mb-4 text-sm leading-relaxed text-white/70 md:text-base">
              We believe in sustainable pace. No crunch culture, no expectations of constant
              availability. We trust you to manage your time and deliver excellence.
            </p>
